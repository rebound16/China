# Data frame of EN and CN city names
...
# Function to read and match variable file with cityname; file = "filename", pos = position of excelcolumn of variable, name = new name of variable (column)
